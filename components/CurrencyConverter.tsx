        ...
        <div className="border border-slate-200 rounded-xl h-max mt-10 px-5 sm:px-12 py-10 pb-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between mt-10 relative">
                <div className="flex items-center justify-center border border-[#cdcdcd] w-full sm:w-0 basis-[100%] sm:basis-[45%] h-[92.98px] py-8 sm:py-0 px-2 lg:px-4 mb-5 sm:mb-0">
                    ...
                    <input name='naira' type="number" value={currencies.naira} onChange={handleValuesChange} placeholder="Amount" className="placeholder:font-lato placeholder:text-[14px] font-bold border-0 pl-2 focus:outline-none focus:ring-0 focus:border-b focus:border-b-[#F91212] mt-1 w-full"/>
                        </div>
                             ...
                             <select id="firstSelect" className="bg-white text-[14px] rounded p-2" >
                                ...
                                <div className="flex items-center justify-center border border-[#cdcdcd] w-full sm:w-0 basis-[100%] sm:basis-[45%] h-[92.98px] py-8 sm:py-0 px-4 mb-1 sm:mb-0">
                                    <div className="flex flex-col items-start justify-center flex-1 gap-4 w-full">
                                        <label htmlFor="Amount" className="font-lato text-[14px]">Amount</label>
                                        <input ref={othersRef} name='others' type="number" onChange={handleValuesChange} value={currencies.others} placeholder="Amount" className="placeholder:font-lato placeholder:text-[14px] font-bold border-0 pl-0 focus:outline-none focus:ring-0 focus:border-b focus:border-b-[#F91212] mt-1 w-full" />
                                        </div>
